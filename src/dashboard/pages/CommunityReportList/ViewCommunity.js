...
const ViewUser = () => {
    ...
    useEffect(() =>{
        const LoadUserData = async() => {
          const result = await axios.get(`http://localhost:5000/request-communityservices/report/${id}`);
        ...
        <Grid container spacing={10} justify='center'>
            ...
            className={cx(styles.card,styles.crime)}>
                        <CardContent className='card-content'>
                            ...
                            <Typography variant='h5' color="text.secondary">Type: {userData?.servicetype}   
                            </Typography>
